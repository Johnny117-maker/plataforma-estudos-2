...
export function criarSnapshotDocumentos(documentos) {
  return (documentos || []).map((doc) => ({
    ...
    papel: doc.papel || 'prova',
    metadadosProva: doc.metadadosProva || null,
    tituloProva: doc.tituloProva || null,
    gabaritoHash: doc.gabaritoHash || null,
    gabaritoVinculado: doc.gabaritoVinculado || null,
